...
class Plot2D():
    def __init__(self):
        ...
        self.scatterPlot2D = self.plot_2d.addPlot(title='Point Cloud Visualizer')
        self.scatterPlot2D.showGrid(x=False,y=False)
        self.scatterPlot2D.setXRange(-5,5,padding=0.01)
        self.scatterPlot2D.setYRange(0,10,padding=0.01)
